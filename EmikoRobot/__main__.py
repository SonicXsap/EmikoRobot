...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/8cfa53035b3384c63fe0e.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Sonic Robot", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Sonic To Your Group ➗", url="t.me/sonicxmngbot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/8cfa53035b3384c63fe0e.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @PISANG_CAVENDISH \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"👋 Hi, I'm Sonic. Nice to meet You.",
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Sonic*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n Click on button bellow to get basic help for SonicRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="www.xxx.com"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, SonicRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/SonicSupport"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/SonicUpdatee"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
        ...
        query.message.edit_text(
            text=f"๏ Credis for Sonic\n"
            "\nHere Developers Making And Give Inspiration For Made The SonicRobot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
